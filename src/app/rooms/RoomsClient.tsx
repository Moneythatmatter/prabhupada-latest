                ...
                <div className="flex flex-col flex-1 justify-between">
                  <div>
                    ...
                    <div className="p-6 sm:p-7 pb-4">
                      ...
                      {/* Room Note if any */}
                      {room.note && (
                        <div className="mb-3 px-3 py-1.5 rounded-md bg-[#FAF8F5] border border-[#E5DECE] text-[11px] text-[#8B6B23] flex items-center gap-1.5">
                          <Info className="w-3.5 h-3.5 text-[#E8A317] shrink-0" />
                          <span>{room.note}</span>
                        </div>
                      )}
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {selectedRoom.amenities.map((feat) => (
                    ...
                    >
                      <div className="w-4 h-4 rounded-full bg-[#E8A317]/20 flex items-center justify-center text-[#E8A317] shrink-0">
