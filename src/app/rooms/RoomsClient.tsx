...
const roomsData = [
  {
    ...
    description:
      "Indulge in the comfort and elegance of Hotel Prabhupada's Premier Room. Thoughtfully designed with modern aesthetics and essential luxury amenities, featuring air conditioning, high-speed Wi-Fi, smart TV, tea/coffee maker, and personalized hospitality for a serene stay in Puri.",
  ...
  },
  {
    ...
    title: "Deluxe Room with Balcony Sea View",
    badgeTitle: "DELUXE ROOM WITH BALCONY SEA VIEW",
    description:
      "Thoughtfully designed for both spiritual and leisure travelers, our Deluxe Room with Balcony Sea View features a comfortable bed, an en-suite bathroom, a well-lit desk area, and a private balcony overlooking coastal ocean vistas with warm Odia hospitality.",
  ...
  },
  {
    ...
    title: "Superior Deluxe Room with Balcony Side Sea View",
    badgeTitle: "SUPERIOR DELUXE WITH BALCONY SIDE SEA VIEW",
    description:
      "Welcome to Hotel Prabhupada, where comfort meets luxury. Our Superior Deluxe Room with Balcony Side Sea View offers the perfect blend of style and seaside functionality, ideal for both spiritual and leisure travelers, with modern amenities and plush bedding.",
  ...
  },
  {
    ...
    title: "Family Quad Sharing Room — No View",
    badgeTitle: "FAMILY QUAD SHARING ROOM — NO VIEW",
    description:
      "At Hotel Prabhupada, we pride ourselves in offering a home away from home. Thoughtfully designed for families and travelling groups, equipped with 2 comfortable double beds, en-suite bathroom, smart TV, tea/coffee maker, and personalized room service for a seamless stay.",
  ...
  },
  {
    ...
    title: "Executive Front Sea View Room — No Balcony",
    badgeTitle: "EXECUTIVE FRONT SEA VIEW — NO BALCONY",
    description:
      "Designed as a sanctuary of peace and comfort, our Executive Front Sea View Room features elegant interiors, plush furnishings, and modern technology. Enjoy panoramic front ocean views and true Odia hospitality for both short and extended stays.",
  ...
  {
    id: "suite-front",
    title: "Suite Front Sea View Room — No Balcony",
    badgeTitle: "SUITE FRONT SEA VIEW — NO BALCONY",
    description:
            ...
            >
              ...
              <div className="mb-8">
                <h4 className="font-serif text-lg text-[#161616] mb-3">
                  Highlights & Included Amenities:
                </h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {selectedRoom.features.map((feat) => (
                    <div
                      key={feat}
                      className="flex items-center gap-2 text-xs font-medium text-[#161616]"
                    >
