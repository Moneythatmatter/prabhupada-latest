...
const roomsData = [
  ...
  },
  {
    ...
    description:
      'Thoughtfully designed for both business and leisure travelers, our Deluxe Room with Balcony Sea View features a comfortable bed, an en-suite bathroom, a well-lit desk area, and a private balcony overlooking coastal ocean vistas with warm Odia hospitality.',
  ...
  },
  {
    ...
    description:
      'Welcome to Hotel Prabhupada, where comfort meets luxury. Our Superior Deluxe Room with Balcony Side Sea View offers the perfect blend of style and seaside functionality, ideal for both business and leisure travelers, with modern amenities and plush bedding.',
  ...
  },
  {
    ...
    description:
      "At Hotel Prabhupada, we pride ourselves on offering a home away from home. Thoughtfully designed for families and travelling groups, equipped with 2 comfortable double beds, en-suite bathroom, smart TV, tea/coffee maker, and personalized room service for a seamless stay.",
