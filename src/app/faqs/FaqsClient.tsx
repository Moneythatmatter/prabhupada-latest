...
const FAQ_DATA: FaqItem[] = [
  {
    ...
    answer: 'Hotel Prabhupada is located on New Marine Drive Road, Near light house, Puri, Odisha 752001, just steps from the sea beach.',
  },
  {
    id: 'faq-2',
