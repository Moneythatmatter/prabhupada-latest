...
export const HOTEL_POLICIES = {
  ...
  petPolicy: {
    ...
    permittedPets: {
      ...
      breedRestrictions:
        "Potentially dangerous breeds are strictly not allowed.",
      otherAnimals: "Birds, reptiles, and exotic pets cannot be accommodated.",
    },
    ...
    feeDetails: {
      ...
      depositNote:
        "Deposit refunded after check-out inspection if no damage or excessive cleaning is needed.",
      cleaningDisinfectionFee:
        "Non-refundable cleaning / disinfection fee as per room category",
      cleaningFine: "Rs. 300/-",
      fineNote:
        "Applicable if pet waste is left in non-designated areas or is not cleaned up immediately by the owner and disposed of in outside dumpsters.",
    },
    checkInProcess: [
    ...
    nonComplianceActions: [
      {
        ...
        action:
          "The hotel reserves the right to discontinue services without refund; may evict.",
      },
      {
        situation: "Damage caused",
        action:
          "Charge will be deducted from the security deposit or billed to the guest account.",
      },
    ],
    ...
    rules: [
      ...
      },
      {
        ...
        highlight:
          "Vaccination certificate, passport/licence & signed waiver form",
        important: true,
      },
      {
        ...
        highlight:
          "Rs. 1,200/night fee + Rs. 4,000/- refundable security deposit",
      },
      {
      ...
      },
      {
        ...
        highlight:
          "No pets on bed/sofa; hotel linen not for pet use; no bathing in shower",
      },
      {
        ...
        highlight:
          "Allowed: Room, Lawn, Lobby Lounge. Restricted: F&B, Pool, Spa, Gym, Banquets",
        important: true,
      },
      {
        ...
        highlight:
          "Guest present for housekeeping; Rs. 300/- fine if waste not cleaned",
      },
      {
        ...
        highlight:
          "Double laundry charge for stained linen; full replacement fee for damage",
      },
      {
        ...
        highlight:
          "Service animals exempt from fees; peak season quota applies",
      },
      {
  ...
  checkInOutPolicy: {
    ...
    rules: [
      ...
      {
        text: "All incidental and room bills due must be fully settled before check-out.",
        important: true,
      },
    ],
  },
