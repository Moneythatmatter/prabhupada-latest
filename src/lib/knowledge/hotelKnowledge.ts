...
export const HOTEL_INFO = {
  ...
  policies: {
    ...
    petPolicy: {
      petFee: 'Rs. 1,200/- per day per night charged to the guest upon arrival.',
      securityDeposit: 'Rs. 4,000/- refundable security deposit collected during check-in and returned at check-out.',
      allowedAreas: 'Guest Room, Main Lobby, Poolside, and Lawn.',
      prohibitedAreas: 'Public areas where Food & Beverages (F&B) are served.',
      cleaningFine: 'Rs. 300/- fine if waste is not properly cleaned and disposed of in outside dumpster.',
    },
    visitorsPolicy: {
